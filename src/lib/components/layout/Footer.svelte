...
<footer
	class="footer-center mt-5 footer footer-horizontal bg-neutral px-5 py-10 text-neutral-content"
>
	...
	<nav>
		<div class="grid grid-flow-col gap-4">
			...
			<a href="https://www.youtube.com/selvamanuel" aria-label="Youtube">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
			...
			<a href="https://www.facebook.com/selva.manuel" aria-label="Facebook">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
			...
			<a href="https://www.instagram.com/pastorselvamanuel/" aria-label="Instagram">
				<Instagram></Instagram>
			</a>
		</div>
	</nav>
	<aside class="">
		<p class="text-xs font-bold">TWO BE ONE</p>
